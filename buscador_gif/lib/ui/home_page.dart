...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if (_search == null || _search.isEmpty)
      ...
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=tEzVNZwR0K3vp2q7LJlWHH5aKhpDWn7v&q=$_search&limit=19&offset=$_offset&rating=G&lang=pt");
          ...
          if (_search == null || index < snapshot.data["data"].length) {
            ...
            return Container(
              child: GestureDetector(
                ...
                onTap: () {
                  setState(() {
                    _offset += 19; // Carregando mais items na lista
                  });
                },
              ),
            );
